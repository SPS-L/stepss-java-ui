...
public final class ToolExtractor {
     ...
     * (which ship under {@code my/stepss/}, alongside {@code StepssUI}), so
     * a class-relative {@code getResourceAsStream} would look under
     * {@code my/stepss/platform/} instead. Resolving against this absolute
     ...
     * resolves to {@code /my/stepss/payload/ramses-linux-x86_64-v3.55.tar.gz}).
     */
    ...
    /**
     * Reads and trims {@code /my/stepss/version.txt} once per JVM run and
