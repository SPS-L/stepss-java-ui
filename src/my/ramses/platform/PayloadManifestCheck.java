 ...
 * {@code src/my/ramses/payload/} based on the asset names in
 ...
 * {@code stage-payloads} has populated {@code src/my/ramses/payload/} and
        ...
        for (ToolSpec spec : Toolchain.SPECS) {
            for (Platform p : Platform.values()) {
                ...
                if (payload == null || !payload.resource.startsWith(PAYLOAD_PREFIX)) {
                    ...
                    // committed directly under src/my/ramses/, not fetched
                    // into src/my/ramses/payload/, so they are out of scope
                    // for this check.
                    continue;
                }
